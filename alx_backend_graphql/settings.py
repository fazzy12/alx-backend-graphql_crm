...
SECRET_KEY = 'django-insecure-%zt$_fsbxz3--1m%#@dyx2@(c@#(i#gf!55z)3)-xjp5^wm8=w'
...
# ----------------------------------------------------------------------
# CELERY CONFIGURATION (Task 4)
# ----------------------------------------------------------------------

# Broker URL pointing to Redis running locally on the default port
